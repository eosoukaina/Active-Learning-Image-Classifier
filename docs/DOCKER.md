...
- **Where to get help**: [GitHub Issues](https://github.com/eosoukaina/active-learning-classifier/issues)
- **Where to file issues**: [GitHub Issues](https://github.com/eosoukaina/active-learning-classifier/issues)
...
MIT License - see [LICENSE](https://github.com/eosoukaina/active-learning-classifier/blob/main/LICENSE)

## Support

For issues and questions:
- GitHub Issues: https://github.com/eosoukaina/active-learning-classifier/issues
